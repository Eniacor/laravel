        ...
        <div class="modal-content">
            <form method="POST" action="/admin/upload/folder" class="form-horizontal">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary">Create Folder
                    </button>
                </div>
            </form>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="lead">
                    ...
                    <kbd><span id="delete-file-name1">file</span></kbd> file?
                </p>
            </div>
            <div class="modal-footer">
                <form method="POST" action="/admin/upload/file">
                    ...
                    <button type="submit" class="btn btn-danger">Delete File
                    </button>
                </form>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form method="POST" action="/admin/upload/folder">
                    ...
                    <button type="submit" class="btn btn-danger">Delete Folder
                    </button>
                </form>
            </div>
        </div>
